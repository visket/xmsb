...
<div id="storageScienceInfo" style="width:100%;height:400px;">
					...
					<td colspan="2">
						<table class="grid" >
							...
							<tr>
								...
								<td><input type="text" id="notationaward" name="notationaward" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="provinceaward" name="provinceaward" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="patentquantity" name="patentquantity" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="inventpatent" name="inventpatent" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
							</tr>
							<tr align="center">
								<td>专利授权数</td>
								<td>发明专利授权数</td>
							...
							<tr>
								<td><input type="text" id="patentauthorize" name="patentauthorize" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="inventpatentauthorize" name="inventpatentauthorize" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="provincepaper" name="provincepaper" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="internationalperiodical" name="internationalperiodical" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
								<td><input type="text" id="publication" name="publication" class="easyui-numberbox" data-options="min:0,precision:0"/></td>
							</tr>
							<!-- <tr>
								<td colspan="5" align="center"><label class="label_font">资金使用情况</label></td>
							</tr>
							<tr>
								<td colspan="5">
					...
					<td colspan="2">
						<table class="grid">
							<tr>
								...
								<td colspan="4"><label class="label_font">其中</label></td>
							</tr>
							<tr>
								<td>专项资金</td>
...
<script type="text/javascript">
	...
	function auditmethods() {
		...
		var type = pagetype == 'auditsearch' ? 'submit' : 'default';
