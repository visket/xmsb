...
<div class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div id="project_datagrid_toolbar" >
    	<div class="td_right">
        ...
        <shiro:hasPermission name="/project/projectDeclare">
            <a onclick="project_list_declare();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-ok'">申报</a>
        </shiro:hasPermission>
    </div>
</div>
