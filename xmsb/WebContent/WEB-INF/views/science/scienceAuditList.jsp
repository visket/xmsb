...
<script type="text/javascript" src="${staticPath }/static/ext/business/science/audit/scienceAudit.js" charset="utf-8"></script>
...
<title>科技项目审核界面</title>
	<script type="text/javascript">
	    ...
	    $(function(){
	    	...
	    	init_scienceAudit_list_datagrid('${path}', '${currentUser.id}', '${currentUser.organizationId}', '${currentUser.unitId}');
	    	...
	    	loadUnitByUnitId('${path}','declareUnitId', "DWLB_QY");
	    });
	    
	    
	    function project_list_fileter() {
	    	$('#scienceAudit_list_datagrid').datagrid('load', { 
	    ...
	    function project_list_reset() {
	    	clearTableToolbar('scienceAudit_list_form');
	    	$('#successStatus_tag').hide();
			$('#successStatus_context').hide();
	    };
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'north',border:false" class="top_sreach" style="height:70px">
		<form id="scienceAudit_list_form" method="POST">
			<table>
				<tr>
					<td>项目编码:</td>
					<td>
    ...
    <div data-options="region:'center',border:false" style="width: 100%;">
        <table id="scienceAudit_list_datagrid" data-options="fit:true,border:false"></table>
    </div>
    
    <div id="scienceAudit_datagrid_toolbar" style="height:25px">
    	<div class="td_left">
    		<shiro:hasPermission name="science/scienceData">
            	<a onclick="scienceData_list_search(${currentUser.id})" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'">查看</a>
        	</shiro:hasPermission>
        	<shiro:hasPermission name="science/auditData">
            	<a id="science_audit" onclick="scienceAuditProcess_list_audit(${currentUser.id})" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-useredit'">审核</a>
        	</shiro:hasPermission>
        	<shiro:hasPermission name="science/disponseOffice">
            	<a id="science_office" onclick="scienceAuditProcess_list_disponseOffice(${currentUser.id})" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-list'">分发处室</a>
        	</shiro:hasPermission>
        	<shiro:hasPermission name="science/disponseExpert">
            	<a id="science_expert" onclick="scienceAuditProcess_list_disponseExpert(${currentUser.id})" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-usergo'">分发专家</a>
        	</shiro:hasPermission>
