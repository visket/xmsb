...
<title>科技项目审核-分发专家页面</title>
	<script type="text/javascript"> 
		...
		$(function(){
			...
			thisrow = row;
	    	init_scienceDisponseExpert_list_datagrid('${path}', thisrow.projectId);
	    	
	    });
	    
		function init_scienceDisponseExpert_list_datagrid(path, projectId){
			science_path=path;
			$('#scienceDisponseExpert_list_datagrid').datagrid({
		...
		function confirmmethods() {
			var rows = $('#scienceDisponseExpert_list_datagrid').datagrid('getSelections');
			if(rows.length != 1){
	    	...
	    	$.ajax({
				...
				success: function (data) {
					...
					if(data.success) {
						...
						top.overall_disponseStatus = 1;//设置流程状态
...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
	    <div data-options="region:'center',border:false" style="width: 100%;">
	        <table id="scienceDisponseExpert_list_datagrid" data-options="fit:true,border:false"></table>
	    </div>
	</div>
</body>
