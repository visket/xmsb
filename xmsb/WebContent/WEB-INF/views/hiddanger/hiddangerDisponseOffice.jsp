...
<title>隐患项目审核-分发处室页面</title>
	<script type="text/javascript"> 
		...
		$(function(){
			...
			thisrow = row;
	    	init_hiddangerDisponseOffice_list_datagrid('${path}', thisrow.projectId);
	    	
	    });
	    
		function init_hiddangerDisponseOffice_list_datagrid(path, projectId){
			hiddanger_path=path;
			$('#hiddangerDisponseOffice_list_datagrid').datagrid({
		...
		function confirmmethods() {
			...
			var rows = $('#hiddangerDisponseOffice_list_datagrid').datagrid('getSelections');
			if(rows.length != 1){
...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
	    <div data-options="region:'center',border:false" style="width: 100%;">
	        <table id="hiddangerDisponseOffice_list_datagrid" data-options="fit:true,border:false"></table>
	    </div>
	</div>
</body>
