...
<script type="text/javascript">
	...
	$(function() {
		...
		if(pagetype != 'add') {
			...
			loadUserCombogrid('${path }', 'creatorId', row.creatorId, row.creatorname);
			loadUserCombogrid('${path }', 'updatorId', row.updatorId, row.updatorname);
			loadUserCombogrid('${path }', 'principaltorId', row.principaltorId, row.principaltorname);
			loadUnitByCombobox('${path }', 'unitId', row.unitId, row.unitname);
			...
			loadUserCombogrid('${path }', 'creatorId','${currentUser.id}','${currentUser.name}');
			loadUserCombogrid('${path }', 'updatorId','${currentUser.id}','${currentUser.name}');
			loadUserCombogrid('${path }', 'principaltorId','${currentUser.id}','${currentUser.name}');
			loadUnitByCombobox('${path }', 'unitId', '${currentUser.unitId}');
			
			//$('#creatorId').combogrid('setValue', '${user.id}');
			//$('#updatorId').combogrid('setValue', '${user.id}');
			//$('#principaltorId').combogrid('setValue', '${user.id}');
			
			$('#typeId').combobox('setValue', 'XMLX_KJXM');
